...
global.website = 'https://github.com/khadherinc/ELLIE-V2' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/3f3ae4aace2d012c11509.jpg'
module.exports = {
  sessionName: process.env.SESSION_ID || "",      //Put Your Session Id Here
  author:  process.env.PACK_AUTHER ||  'K007',
  packname:  process.env.PACK_NAME || 'MADE BY UNITY',
  ...
  caption :process.env.CAPTION || "\t*POWERED BY ELLIE V2* follow instagram : abd_khadher___ ",	
